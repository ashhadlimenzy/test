...
use App\Http\Helpers\User\UserHelper;
use App\Http\Requests\User\PasswordUpdateURequest;
...
class ProfileController extends BaseController
{
    ...
    {
        $response = UserHelper::uploadBase64ProfileImage( 'profile_image', $this->getLoggedUserId());
        if ($response['status']) {
            $admin = Auth::user();
            $admin->update([

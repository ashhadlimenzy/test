    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                     src="{{ ProfileHelper::getProfileImage(AuthConstants::GUARD_ADMIN) }}"
                            ...
                            <h3 class="profile-username text-center">{{ ProfileHelper::getFullName(AuthConstants::GUARD_ADMIN) }}</h3>
                        </div>
                    </div>
                </div>
                <!--End Profile Image -->
                ...
                <!-- Update Profile -->
                <div class="col-md-9">
                    <form class="form-horizontal" action="{{ route('admin.profile.update') }}" method="POST" role="form" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-0">
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link active" href="{{route('admin.profile.index')}}">Update Profile</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('admin.profile.change-password')}}">Change Password</a></li>
                            </ul>
                        </div>
                        <div class="card-body">
...
@include('pages.admin.profile.modal.image-upload')
@endsection
@push('scripts')

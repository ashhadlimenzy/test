...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- Update Profile -->
                <div class="col-md-9">
                    <form class="form-horizontal" action="{{ route('doctor.profile.update') }}" method="POST" role="form" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header p-0">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a class="nav-link active" href="{{route('doctor.profile.index')}}">Update Profile</a></li>
                                    <li class="nav-item"><a class="nav-link" href="{{route('doctor.profile.change-password')}}">Change Password</a></li>
                                </ul>
                            </div>
                            <div class="card-body">
    ...
    @include('pages.doctor.profile.modal.image-upload')
@endsection
@push('scripts')

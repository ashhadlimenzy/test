    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- Reset Password -->
                <div class="col-md-9">
                    <form class="form-horizontal" action="{{route('user.profile.update-password')}}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="card card-primary card-outline card-outline-tabs">
                            <div class="card-header p-0">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a class="nav-link" href="{{route('user.profile.index')}}">Update Profile</a></li>
                                    <li class="nav-item"><a class="nav-link active" href="{{route('user.profile.change-password')}}">Change Password</a></li>
                                </ul>
                            </div>
                            <div class="card-body">

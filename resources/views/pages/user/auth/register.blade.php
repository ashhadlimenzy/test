...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header"><p class="login-box-msg">Register and Login to start your user session</p></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" name="address" rows="4" cols="50" class="form-control @error('address') is-invalid @enderror" value="{{ old('address') }}" required autocomplete="address" autofocus>
                                </textarea>    
